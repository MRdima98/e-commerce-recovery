...
from hotel.views import delete_room
from home.views import home, search
from login.views import log_in, register, my_logout, go_back

urlpatterns = [
    path('admin/', admin.site.urls),

    path('', home, name='home'),
    path('hotel/', new_hotel, name='hotel'),
    path('struttura/<int:id>', struttura, name='struttura'),
